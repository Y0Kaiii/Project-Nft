...
import './Popup.css';
import './MainMint.css';
import FuzzyLogo from './assets/images/FuzzyFriendsLogo.png'
...
const MainMint = ({ accounts, setAccounts}) => {
    ...
    return (
        <div className="main-mint-container">
            <div className="left-content">
                ...
                <div className="hero-content">
                    <h2>FUZZY FRIENDS</h2>
                    <p>
                    Welcome to the world of FUZZY FRIENDS, an NFT collection featuring a diverse group of lovable furry companions. From playful pups to mischievous kittens and cuddly creatures, each friend has a unique personality waiting to be discovered.
                    </p>
                ...
                <div className="right-content">
                    <img src={FuzzyLogo} alt="Fuzzy Friends" className="NFT-Exam" />
                </div>
        </div>
    );
};
